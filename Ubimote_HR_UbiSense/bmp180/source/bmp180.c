...
int bmp180_init(struct bmp180_t *bmp180)
{
   ...
   comres += p_bmp180->BMP180_BUS_READ_FUNC(p_bmp180->dev_addr, BMP180_CHIP_ID__REG, &data, 1);  /* read Chip Id */
   ...
   p_bmp180->sw_oss = 0;
	if (p_bmp180->chip_id == BMP180_CHIP_ID) {
		...
		comres += p_bmp180->BMP180_BUS_READ_FUNC(p_bmp180->dev_addr, BMP180_VERSION_REG, &data, 1);
...
int bmp180_get_cal_param(void)
{
   ...
   comres = p_bmp180->BMP180_BUS_READ_FUNC(p_bmp180->dev_addr, BMP180_PROM_START__ADDR, data, BMP180_PROM_DATA__LEN);
...
unsigned short bmp180_get_ut(void)
{
   ...
   //while(time--);
	 comres += p_bmp180->BMP180_BUS_READ_FUNC(p_bmp180->dev_addr, BMP180_ADC_OUT_MSB_REG, data, 2);
